...
var getTokenFromDB = function (userId, userType, token, callback) {
    ...
    async.series([
        function (cb) {
            switch (userType) {
                case Config.APP_CONSTANTS.DATABASE.USER_ROLES.FARMER:
                    ...
                    break;
                case Config.APP_CONSTANTS.DATABASE.USER_ROLES.EXPORTER:
                    Service.UserService.getUser(criteria, {}, { lean: true }, function (err, dataAry) {
                        if (err) {
                            cb(err)
                        } else {
                    ...
                    break;
                case Config.APP_CONSTANTS.DATABASE.USER_ROLES.IMPORTER:
                    Service.UserService.getUser(criteria, {}, { lean: true }, function (err, dataAry) {
                        if (err) {
                            cb(err)
                        } else {
                    ...
                    break;
                case Config.APP_CONSTANTS.DATABASE.USER_ROLES.CONSUMER:
                    Service.UserService.getUser(criteria, {}, { lean: true }, function (err, dataAry) {
                        if (err) {
                            cb(err)
                        } else {
